  ...
  <div className="max-w-screen-xl mx-auto px-4 text-base-content gap-12 md:px-8 lg:flex">
    <div className="max-w-md">
      <h3 className="text-base-content text-3xl font-semibold sm:text-4xl">
        Let&rsquor;s connect
      </h3>
      <p className="mt-3">
        We&rsquor;re here to help and answer any question you might have, We look
    ...
    <div>
      <ul className="mt-12 gap-y-6 gap-x-12 items-center md:flex lg:gap-x-0 lg:mt-0">
        <li className="space-y-3 border-t py-6 md:max-w-sm md:py-0 md:border-t-0 lg:border-l lg:px-12 lg:max-w-none">
          ...
          <a href="javascript:void(0)" className="flex items-center gap-1 text-sm text-primary duration-150 hover:text-primary/85 font-medium">Join our Discord<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
        ...
        <li className="space-y-3 border-t py-6 md:max-w-sm md:py-0 md:border-t-0 lg:border-l lg:px-12 lg:max-w-none">
          ...
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
          <a href="javascript:void(0)" className="flex items-center gap-1 text-sm text-primary duration-150 hover:text-primary/85 font-medium">Send us DMs<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
              <path fillRule="evenodd" d="M5 10a.75.75 0 01.75-.75h6.638L10.23 7.29a.75.75 0 111.04-1.08l3.5 3.25a.75.75 0 010 1.08l-3.5 3.25a.75.75 0 11-1.04-1.08l2.158-1.96H5.75A.75.75 0 015 10z" clipRule="evenodd" />
            </svg>
          </a>
        </li>
