<ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
  <li>
    ...
    <div className="timeline-start md:text-end mb-10">
      ...
      The Apple Macintosh&mdash;later rebranded as the Macintosh 128K&mdash;is the original
  ...
  <li>
    ...
    <div className="timeline-start md:text-end mb-10">
      ...
      version was released on October 23, 2001, about 8+1&frasl;2 months after the
