       ...
       { /*-use a map loop*/ }
          <li>
            ...
            <div className="mt-4">
              ...
              <p className="text-base-content mt-2">item.desc</p>
              <div className="mt-3 flex gap-4 text-base-content">
                <a href="item.twitter" aria-label="Twitter">
                  <svg className="w-5 h-5 duration-150 hover:text-base-content" fill="currentColor" viewBox="0 0 48 48">
                ...
                </a><a href="item.github" aria-label="GitHub">
                  <svg className="w-5 h-5 duration-150 hover:text-base-content" fill="currentColor" viewBox="0 0 48 48">
                ...
                </a><a href="item.linkedin" aria-label="LinkedIn">
                  <svg className="w-5 h-5 duration-150 hover:text-base-content" fill="none" viewBox="0 0 48 48">
              ...
              </a></div><a href="item.linkedin" aria-label="LinkedIn">
            </a></div><a href="item.linkedin" aria-label="LinkedIn">
          </a></li><a href="item.linkedin" aria-label="LinkedIn">
        
      </a></ul><a href="item.linkedin" aria-label="LinkedIn">
    </a></div><a href="item.linkedin" aria-label="LinkedIn">
  </a></div><a href="item.linkedin" aria-label="LinkedIn">
</a></section>