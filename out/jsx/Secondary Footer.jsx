      ...
      <div className="flex-1">
        ...
        <form onSubmit={event => {}}>
          ...
          <div className="max-w-sm flex items-center border rounded-md p-1">
            <input type="email" placeholder="Enter your email" className="w-full p-2.5 outline-none" />
            <button className="p-2.5 rounded-md text-base-100 bg-primary outline-none shadow-md focus:shadow-none sm:px-5">
              Subscribe
            </button>
          </div>
        </form>
        ...
        <ul className="flex items-center space-x-4">
          <li className="w-10 h-10 border rounded-full flex items-center justify-center">
            <a href="javascript:void()">
              <svg className="svg-icon w-6 h-6 text-primary/80" viewBox="0 0 20 20">
          ...
          <li className="w-10 h-10 border rounded-full flex items-center justify-center">
            <a href="javascript:void()">
              <svg className="svg-icon w-6 h-6 text-error" viewBox="0 0 20 20">
