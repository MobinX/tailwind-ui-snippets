<div>
  <section>
    <div className="max-w-screen-xl mx-auto px-4 py-28 gap-12 text-base-content md:px-8 xl:flex">
      <div className="space-y-5 max-w-2xl mx-auto text-center xl:text-left">
        <div className="flex flex-wrap items-center justify-center gap-6 xl:justify-start">
          <div className="flex items-center gap-x-2 text-base-content text-sm">
        ...
        <h1 className="text-4xl text-base-content font-extrabold mx-auto md:text-5xl">
        ...
        <div className="items-center justify-center gap-x-3 space-y-3 sm:flex sm:space-y-0 xl:justify-start">
          <a href="javascript:void(0)" className="flex items-center justify-center gap-x-2 py-2 px-4 text-base-100 font-medium bg-base-content duration-150 hover:bg-base-content active:bg-base-content rounded-lg md:inline-flex">
            Browse courses
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
      ...
      <div className="flex-1 max-w-xl mx-auto mt-14 xl:mt-0">
        <div className="relative">
          ...
          <button className="absolute w-16 h-16 rounded-full inset-0 m-auto duration-150 bg-primary hover:bg-primary ring-offset-2 focus:ring text-base-100" onClick={event => {}}>
    ...
    <div x-bind:class="{ 'flex': isVideoPoppedUp, 'hidden': !isVideoPoppedUp }" className="fixed inset-0 w-full h-full flex items-center justify-center hidden">
      <div className="absolute inset-0 w-full h-full bg-black/50" onClick={event => {}} />
      <div className="px-4 relative">
        <button className="w-12 h-12 mb-5 rounded-full duration-150 bg-base-content hover:bg-base-content text-base-100" onClick={event => {}}>
        ...
        <video x-ref="video" className="rounded-lg w-full max-w-2xl" controls>
