<footer className="p-10 footer bg-base-200 text-base-content rounded">
  ...
  <form>
    ...
    <fieldset className="form-control w-80">
      <label className="label" htmlFor="input1"><span className="label-text">Enter your email address</span></label>
      <div className="join">
        <input type="text" placeholder="username@site.com" className="input input-bordered join-item" id="input1" />
