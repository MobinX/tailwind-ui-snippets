<><div>
  <footer className="text-base-content bg-base-100 px-4 py-5 max-w-screen-xl mx-auto md:px-8">
    ...
    </a><div className="mt-8 items-center justify-between sm:flex"><a href="item.href">
      <div className="mt-4 sm:mt-0">
        &copy; 2022 Float UI All rights reserved.
      </div>
      </a><div className="mt-6 sm:mt-0"><a href="item.href">
        </a><ul className="flex items-center space-x-4"><a href="item.href">
          </a><li className="w-10 h-10 border rounded-full flex items-center justify-center"><a href="item.href">
