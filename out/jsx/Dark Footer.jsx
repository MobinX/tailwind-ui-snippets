    ...
    <div className="max-w-screen-xl mx-auto px-4 md:px-8">
      <div className="justify-between items-center gap-12 md:flex">
        <div className="flex-1 max-w-lg">
          <h3 className="text-base-100 text-2xl font-bold">
            Get our beautiful newsletter straight to your inbox.
          </h3>
        </div>
        <div className="flex-1 mt-6 md:mt-0">
          <form onSubmit={event => {}} className="flex items-center gap-x-3 md:justify-end">
            <div className="relative">
              ...
              <input type="email" required placeholder="Enter your email" className="w-full pl-12 pr-3 py-2 text-base-content bg-base-100 outline-none border focus:border-primary shadow-sm rounded-lg" />
            </div>
            <button className="block w-auto py-3 px-4 font-medium text-sm text-center text-base-100 bg-primary hover:bg-primary/90 active:bg-primary active:shadow-none rounded-lg shadow">
              Subscribe
            </button>
          </form>
        </div>
      ...
      <div className="mt-10 py-10 border-t border-base-content items-center justify-between sm:flex">
        <p className="text-base-300/70">
          &copy; 2022 Float UI Inc. All rights reserved.
        </p>
        <div className="flex items-center gap-x-6 text-base-content mt-6">
          <a href="javascript:void()">
            <svg className="w-6 h-6 hover:text-base-content duration-150" fill="none" viewBox="0 0 48 48">
              <g clipPath="url(#a)">
          ...
          <a href="javascript:void()">
            <svg className="w-6 h-6 hover:text-base-content duration-150" fill="currentColor" viewBox="0 0 48 48">
