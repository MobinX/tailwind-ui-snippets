<div className="flex items-center gap-x-12">
  ...
  <div className="relative w-6 h-6">
    <span className="absolute -bottom-0.5 right-1 w-1.5 h-1.5 rounded-full border border-base-100 bg-primary" />
    <img src="https://randomuser.me/api/portraits/women/79.jpg" className="w-full h-full rounded-full" />
  </div>
  { /* // Avatar 2 */ }
  <div className="relative w-8 h-8">
    <span className="absolute -bottom-0.5 right-1 w-2 h-2 rounded-full border border-base-100 bg-primary" />
    <img src="https://api.uifaces.co/our-content/donated/xZ4wg2Xj.jpg" className="w-full h-full rounded-full" />
  </div>
  { /* // Avatar 3 */ }
  <div className="relative w-10 h-10">
    <span className="absolute -bottom-0.5 right-1 w-2.5 h-2.5 rounded-full border border-base-100 bg-primary" />
  ...
  <div className="relative w-12 h-12">
    <span className="absolute -bottom-0.5 right-1 w-3 h-3 rounded-full border border-base-100 bg-primary" />
    <img src="https://randomuser.me/api/portraits/men/86.jpg" className="w-full h-full rounded-full" />
  </div>
  { /* // Avatar 5 */ }
  <div className="relative w-16 h-16">
    <span className="absolute -bottom-px right-1 w-4 h-4 rounded-full border border-base-100 bg-primary" />
