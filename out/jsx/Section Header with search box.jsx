    ...
    <div className="items-start justify-between gap-x-4 py-4 border-b sm:flex">
        ...
        <div className="mt-6 sm:mt-0">
            <div className="relative">
                ...
                <input type="text" placeholder="Enter your email" className="w-full pl-12 pr-3 py-2 text-base-content bg-transparent outline-none border focus:border-primary rounded-lg sm:max-w-xs" />
            </div>
        </div>
    </div>
</div>