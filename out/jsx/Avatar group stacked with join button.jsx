<div className="flex -space-x-2 overflow-hidden">
    ...
    <img src="https://images.unsplash.com/photo-1511485977113-f34c92461ad9?ixlib=rb-1.2.1&q=80&fm=jpg&crop=faces&fit=crop&h=200&w=200&ixid=eyJhcHBfaWQiOjE3Nzg0fQ" className="w-10 h-10 rounded-full border-2 border-base-100" />
    <img src="https://randomuser.me/api/portraits/men/18.jpg" className="w-10 h-10 rounded-full border-2 border-base-100" />
    <div className="flex items-center justify-center w-10 h-10 rounded-full border-2 border-base-100 bg-base-200 text-base-content text-xs font-medium">
        +100
    </div>
    <a href="javascript:void(0)" className="flex items-center justify-center translate-x-5 w-10 h-10 rounded-full border-dashed border bg-base-100 hover:bg-base-200 active:bg-base-300 text-base-content">
