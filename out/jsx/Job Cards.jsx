<div className="py-28">
  <div className="max-w-screen-lg mx-auto px-4 md:px-8">
    ...
    <ul className="mt-12 divide-y space-y-3">
     { /*-use a map loop*/ }
        <li className="px-4 py-5 duration-150 hover:border-base-100 hover:rounded-xl hover:bg-base-200">
          <a href="item.path" className="space-y-3">
            <div className="flex items-center gap-x-3">
              <div className="bg-base-100 w-14 h-14 border rounded-full flex items-center justify-center">
                <div>item.company_icon</div>
              </div>
              <div>
                <span className="block text-sm text-primary font-medium">item.company_name</span>
                <h3 className="text-base text-base-content font-semibold mt-1">item.job_title</h3>
              </div>
            </div>
            <p className="text-base-content sm:text-sm">item.job_description</p>
            <div className="text-sm text-base-content flex items-center gap-6">
              <span className="flex items-center gap-2">
                <svg className="w-5 h-5 text-base-content" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        </a></li><a href="item.path" className="space-y-3">
      
    </a></ul><a href="item.path" className="space-y-3">
  </a></div><a href="item.path" className="space-y-3">
</a></div>