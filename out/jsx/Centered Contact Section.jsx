      ...
      <form onSubmit={event => { event.preventDefault(); }} className="space-y-5">
        ...
        <div>
          ...
          <div className="relative mt-2">
            ...
            <input type="number" placeholder="+1 (555) 000-000" required className="w-full pl-[4.5rem] pr-3 py-2 appearance-none bg-transparent outline-none border focus:border-primary shadow-sm rounded-lg" />
          </div>
        </div>
        <div>
          <label className="font-medium">
